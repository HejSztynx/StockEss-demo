...
@Entity
@DiscriminatorValue("FALL")
@AllArgsConstructor
@NoArgsConstructor
@Setter
@Getter
public class FallCondition extends BaseCondition {
    ...
    public Optional<String> evaluate(ConditionEvaluationContext context) {
        ...
        float change = pastPrice - currentPrice;
    ...
    protected void modifyDto(ConditionDto dto) {
        ...
        dto.setConditionType(ConditionType.FALL);
    }
}
